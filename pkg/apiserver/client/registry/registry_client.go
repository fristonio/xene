...
type ClientService interface {
	...
	GetAPIV1InfoWorkflowName(params *GetAPIV1InfoWorkflowNameParams, authInfo runtime.ClientAuthInfoWriter) (*GetAPIV1InfoWorkflowNameOK, error)
...
/*
  GetAPIV1InfoWorkflowName returns verbose information about a workflow
*/
func (a *Client) GetAPIV1InfoWorkflowName(params *GetAPIV1InfoWorkflowNameParams, authInfo runtime.ClientAuthInfoWriter) (*GetAPIV1InfoWorkflowNameOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetAPIV1InfoWorkflowNameParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetAPIV1InfoWorkflowName",
		Method:             "GET",
		PathPattern:        "/api/v1/info/workflow/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetAPIV1InfoWorkflowNameReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	success, ok := result.(*GetAPIV1InfoWorkflowNameOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAPIV1InfoWorkflowName: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
